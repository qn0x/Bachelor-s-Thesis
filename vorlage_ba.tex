...
\begin{document}
    ...
    \listoftodos
    \include{010_einleitung}
    \include{020_state_of_the_art}
    %\include{0211_notes_bc}
    \include{021_doublespend}
    \include{022_blockchain}
    \include{023_iot}
    \include{024_security_analysis}
    \include{025_smart_locks}
    \include{030_analysis}
    \include{031_known_weaknesses}
    \include{032_cvss_scoring}
    \include{033_requirements_prototype}
    \include{040_prototype}
    \include{050_evaluation}
    \include{060_comparison}
    \include{070_ending}
    \include{99_fragen}
    \nocite{*}
