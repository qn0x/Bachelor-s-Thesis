...
\lstset{
    ...
    morekeywords={asset,identified,participant,enum,transaction,namespace},
...
\setlist[FA]{label=\textsf\textbf{{FA-\arabic*}},leftmargin=*,labelindent=0.4cm} % align=left,
