...
\label{sec:analysis_vulns}
    ...
    \begin{itemize}[leftmargin=0cm,label={}]
        \item \emph{State Consistency Attacks}\cite{Ho2016}\todo[color=orange]{löschen?}\\
    ...
    \subsubsection*{I2: Insecure Authentification/Authorization}
        \begin{itemize}[leftmargin=0cm,label={}]
            \item \emph{Insufficient Password Protection}\cite{Ye2017}\label{enum:pwd_prot}\\
            ...
            \item \emph{Insecure API: Privilege Escalation}\cite{Fuller2017,Lariviere2015}\label{enum:priv_esc}\\
                Produkt: August\\
                Voraussetzungen: \\
                Die in \fref{sec:sota_smart_locks} vorgestellte Kommunikation via Wifi zwischen dem Webserver: 
                Ebenfalls möglich war eine Privilege Escalation, in dem ein String von 'user' auf 'superuser' geändert wurde.
            \item \emph{Insecure Password Policy}\cite{Rose2016,Ye2017,Jmaxxz2015a}\label{enum:pwd_pol}\\
            ...
            \item \emph{Phishing?}\cite{Ye2017}\\
    ...
    \subsubsection*{I3: Insecure Network Services}
        \begin{itemize}[leftmargin=0cm,label={}]
            \item \emph{Denial of Service via Commands}\cite{Ye2017}\label{enum:dos_cmd}\\
    	        Produkt: August Smart Lock \\ 
		    ...
		    \item \emph{Denial of Service (via manufacturer's server)}\cite{Ye2017}\label{enum:dos_server}\\
                Produkt: Lockitron\\
            ...
            \item \emph{Denial of Service via Bluetooth}\cite{Ye2017}\label{enum:dos_ble}\\
    	        Produkt: alle\\ 
                Voraussetzungen: keine\\
            ...
            \item \emph{Access Log Evasion}\cite{Ho2016}\\
                Produkt: August, Danalock, Kevo, Okidokeys, Lockitron\\
                Voraussetzungen: \\
    ...
    \subsubsection*{I4: Lack of Transport Encryption/Integrity Verification}
        \begin{itemize}[leftmargin=0cm,label={}]
            \item \emph{Insecure Password Transmission}\cite{Rose2016}\label{enum:pwd_trns}\\
            ...
            \item \emph{Insecure Bluetooth-Pairing - Session Key}\cite{Fuller2017}\label{enum:ble_sk}\\
                Produkt: August\\
                Voraussetzungen: \\
	        ...
	        \item \emph{Revocation Evasion}\cite{Fuller2017,Ho2016}\\
                Produkt: August, Danalock, Kevo, Okidokeys, Lockitron\\
                Voraussetzungen: \\
    ...
    \subsubsection*{I5: Privacy Concerns}
        \begin{itemize}[leftmargin=0cm,label={}]
            \item \emph{Extracted User Data}\cite{Lariviere2015,Ye2017}\label{enum:user_data}\\
                Produkt: August Smart Lock\\ 
    ...
    \subsubsection*{I7: Insecure Mobile Interface}
        \begin{itemize}[leftmargin=0cm,label={}]
            \item \emph{Stolen User Settings}\cite{Ye2017}\label{enum:user_settings}\\
                Produkt: August Smart Lock\\ 
                Voraussetzungen: Angreifer hat Zugriff auf das Smartphone eines Nutzers und auf dem Smartphone selbst Root-Rechte\\
		    ...
		    \item \emph{Insecure Bluetooth-Pairing}\cite{Tierney2018,Rose2016,Ye2017,Fuller2017}\\
