...
\label{sec:prototype_framework}
    ...
    \begin{itemize}[noitemsep]
        ...
        \item keine public Blockchain, da der Teilnehmerkreis im Anwendungsfall von Smart Locks nicht sehr groß ist - verhindern von in \fref{sec:sota} vorgestellten Angriffen, \gls{pow} ist energieaufwändig, für \gls{iot} also eher ungeeignet
    \end{itemize}
    \medskip
