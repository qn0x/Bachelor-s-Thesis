...
%in neuerern Automodellen: das Gerät merkt, wenn ein legitimer Nutzer die Tür öffenen will.\cite{Ho2016}
    ...
    Nachdem dem vorangegangenen Hype\todo[color=yellow]{nein.} um die Kryptowährung Bitcoin sich das Konzept der Blockchain als potentiell zukunftsweisende herauskristallisiert hatte, wird derzeit in verschiedenen Anwendungsszenarien damit experimentiert. 
