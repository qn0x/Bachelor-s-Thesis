...
\label{sec:problem}
	...
	Weiterhin werden \gls{iot}(\fref{sec:sota_iot}), Smart Home(\fref{sec:sota_iot_smart_home}) und Smart Locks(\fref{sec:sota_smart_locks}) erklärt\todo[color=orange]{wdh}.
