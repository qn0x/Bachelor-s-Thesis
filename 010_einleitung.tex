...
\label{sec:problem}
    ...
    \label{sec:problem_relatedWork}
        ...
        Das Konzept basiert auf einer öffentlichen Blockchain und setzt den Fokus auf eine physische Umsetzung mittels zusätzlichen Sensoren, die potentielle Replay-Angriffe verhindern sollen.\todo[color=green]{neue Seite}
        \newpage
