...
\label{sec:analysis_cvss}
	...
	In der detallierten \fref{tab:analysis_cvss_long}, welche sich im Anhang befindet, werden sämtliche einzelne Faktoren aufgelistet, um die Bewertung einzelner Faktoren zu nachvollziehbar zu machen.
